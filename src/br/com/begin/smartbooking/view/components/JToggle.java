...
import br.com.begin.smartbooking.view.windows.Window;
...
public class JToggle extends JRoundedPanel implements Runnable, ColorMode{
	...
	public void initializeComponents() {
		...
		imgIcon = new JImage("../assets/images/moon.png", 30, 30);
	...
	public void changeToLightMode() {
		...
		imgIcon.drawImage("../assets/images/moon.png");
		lblCircle.setBackground(labelColor);

		int finalPositionImgIcon = 10;
		int finalPositionLblCircle = getWidth() - 10;

		for (int xImgIcon = imgIcon.getX(), xLblCircle = lblCircle.getX(); 
				xImgIcon > finalPositionImgIcon && 
	...
	public void changeToDarkMode () {
		...
		imgIcon.drawImage("../assets/images/sun.png");
